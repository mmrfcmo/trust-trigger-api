...
Stop. Do not paste anything after this. Click Commit changes.

Then go to github.com/mmrfcmo/trust-trigger-api/blob/main/app/core/config.py

Pencil icon. Select all, delete. Paste ONLY this:
