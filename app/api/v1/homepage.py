...
function render(){
  ...
  h+='</ul>';
  h+='<div class="text-center"><a href="https://social.prospectrocket.com/AR/DigitalTrustReportMeeting" class="inline-block rounded-lg bg-amber-500 px-8 py-3 text-base font-bold text-white shadow-sm hover:bg-amber-400">Book Your Free 20-Minute Trust Review &rarr;</a><p class="text-xs text-slate-500 mt-2">Free. No obligation.</p></div>';
  h+='</div></div>';
  ...
  h+='<div class="mt-8 text-center"><a href="https://social.prospectrocket.com/AR/DigitalTrustReportMeeting" class="inline-block rounded-lg bg-amber-500 px-8 py-3.5 text-base font-bold text-white shadow-sm hover:bg-amber-400">Book Your Free Trust Review &rarr;</a></div>';
