...
class TrustJourney(Base):
    ...
    lead_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("leads.id"), nullable=False, unique=True, index=True)
...
class JourneyMilestone(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    journey_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("trust_journeys.id"), nullable=False, index=True)
...
class BeforeAfterReport(Base):
    ...
    journey_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("trust_journeys.id"), nullable=True)
    ...
    before_scan_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=True)
    after_scan_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=True)
